...
for _,task_name in enumerate(task_list):
    ...
    for prompt in task['prompts']:
        ...
        train_data = data_class.load_dataset('train')
        ...
        for idx,data in enumerate(train_data):
            ...
            train_instances[task_name][prompt][str(idx)]=formatted_d
            
print(len(train_instances))
print(len(train_instances['cos_e']))
        
with open(f'seen_train_{max_num_instances}.json','w') as f:
