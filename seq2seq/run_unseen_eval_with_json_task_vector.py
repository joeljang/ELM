...
def main():
    ...
    "hellaswag","hellaswag","hellaswag","hellaswag","hellaswag",
    ...
    "super_glue_copa","super_glue_copa","super_glue_copa","super_glue_copa","super_glue_copa","super_glue_copa","super_glue_copa","super_glue_copa",
    ...
    "winogrande","winogrande","winogrande","winogrande","winogrande"]
    ...
    "winogrande_xl","winogrande_xl","winogrande_xl","winogrande_xl","winogrande_xl"
    ]
    data_args.eval_prompts= [
        "complete_first_then","Randomized prompts template","Predict ending with hint","how_ends","if_begins_how_continues",
        ...
        "MNLI crowdsource","should assume","does it follow that","GPT-3 style","based on the previous passage","justified in saying","take the following as truth","must be true","can we infer","guaranteed/possible/impossible","always/sometimes/never","does this imply","consider always/sometimes/never","claim true/false/inconclusive","guaranteed true",
        "MNLI crowdsource","should assume","does it follow that","GPT-3 style","based on the previous passage","justified in saying","take the following as truth","must be true","can we infer","guaranteed/possible/impossible","always/sometimes/never","does this imply","consider always/sometimes/never","claim true/false/inconclusive","guaranteed true",
        "exercise","i_am_hesitating","plausible_alternatives","C1 or C2? premise, so/because\u2026","best_option","more likely","cause_effect","choose",
        ...
        "does underscore refer to","stand for","underscore refer to","fill in the blank","Replace"
    ]
    data_args.test_dataset_config_name = data_args.test_dataset_config_name
    data_args.txt_save_dir= "output_logs_unseen_eval_ct0_replication"
    #temp
