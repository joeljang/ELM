...
from projections.fwh_cuda import fast_walsh_hadamard_transform as fast_walsh_hadamard_transform_cuda
import torch
import numpy as np
        ...
        with torch.enable_grad():
            for name, base, localname in self.name_base_localname:
                ...
                ray = self.get_projected_param(
                    module.intrinsic_parameter, DD, self.projection_params[name], init_shape)
                if self.said:
