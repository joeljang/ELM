...
def main():
    ...
    "wiki_auto","wiki_auto","asset","asset",  
    "ct0_gigaword","ct0_gigaword","ct0_gigaword","ct0_gigaword","ct0_gigaword","ct0_gigaword",
    "haiku",
    "covid_qa",
    "eli5",
    "emdg",
    ...
    data_args.eval_prompts= [
        "simplification_1","simplification_2","simplification_1","simplification_2",
        "constrain_contain+make_a_title","constrain_contain+write_its_sentence","constrain_end+make_a_title","constrain_end+write_its_sentence","constrain_start+make_a_title","constrain_start+write_its_sentence",
        "do_nothing",
        "covid_qa_deepset",
    ...
    data_args.txt_save_dir= "output_logs_target_eval_ct0_replication"
    #temp
    ...
    if training_args.do_eval:
        max_target_lengths = [AutoTask.get(dataset_name, dataset_config_name, prompt=eval_prompt).get_max_target_length(
            tokenizer=tokenizer, default_max_length=data_args.max_target_length)
            for dataset_name, dataset_config_name, eval_prompt in zip(data_args.eval_dataset_name, data_args.eval_dataset_config_name, data_args.eval_prompts)]
        with open('/home/joel_jang/seungone/RoE/seq2seq/data/manual/target_eval_300.json','r') as f:
            eval_datasets = {}
