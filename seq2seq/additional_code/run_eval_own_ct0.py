...
def main():
    ...
    print(len(data_args.eval_dataset_name))
    print(len(data_args.eval_dataset_config_name))
    print(len(data_args.eval_prompts))
    ...
    def compute_metrics(eval_preds, task_name):
        ...
        # if os.path.isdir(f"./output_logs_t0_unseen/{data_args.dataset_name[0].replace('/',' ').replace('-',' ')}") == False:
        #     os.mkdir(f"./output_logs_t0_unseen/{data_args.dataset_name[0].replace('/',' ').replace('-',' ')}")
        # with open(f"./output_logs_t0_unseen/{data_args.dataset_name[0].replace('/',' ').replace('-',' ')}/{data_args.dataset_name[0].replace('/',' ').replace('-',' ')}*{data_args.train_prompts[0].replace('/',' ').replace('-',' ')}-{task_name.replace('/',' ').replace('-',' ')}.txt",'a') as f:
        ...
        #with open(f"./output_logs/{data_args.dataset_name[0].replace('/',' ').replace('-',' ')}*{data_args.train_prompts[0].replace('/',' ').replace('-',' ')}-{task_name.replace('/',' ').replace('-',' ')}.txt",'a') as f:
            f.write("####################\n")
            f.write(task_name)
            f.write("\n")
