...
import sys 
sys.path.append('..')
from adapters import (AutoAdapterConfig, AdapterController, Adapter, HyperComplexAdapter)
...
def get_adapter_config(adapter_args, data_args, training_args, config):
    if adapter_args.train_task_adapters or adapter_args.prefix_tuning or adapter_args.bitfit:
        ...
        adapter_config.adapters_cur_training_task = adapter_args.adapters_cur_training_task
    else:
        adapter_config = None
