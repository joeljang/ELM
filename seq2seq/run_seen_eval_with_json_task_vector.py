...
def main():
    ...
    parser = HfArgumentParser((ModelArguments, DataTrainingArguments, TrainingArguments,
                               AdapterTrainingArguments),conflict_handler='resolve')
    ...
    #model_args.model_name_or_path = f"/mnt/disks/sdc/outputs/{data_args.task_name[0]}_last.pt"    
    #model_args.model_name_or_path = f"/home/joel_jang/doyoung/ROE_doyoung/outputs/phase8_last.pt"
    model_args.model_name_or_path = "/home/joel_jang/seungone/T0_continual_learning/ct0/ct0_checkpoint"
    # Initializae wandb
    ...
    #checkpoint_params = torch.load(model_args.model_name_or_path)
    ...
    #     param.data = checkpoint_params[name].cuda()
    # print(f'Finished loading checkpoint weights! :)')
    ...
    "xsum","xsum","xsum","xsum","xsum","xsum","xsum","xsum","xsum","xsum",
    "trec","trec","trec","trec","trec","trec","trec","trec","trec","trec","trec","trec","trec","trec","trec","trec","trec","trec",
    "cos_e","cos_e","cos_e","cos_e","cos_e","cos_e","cos_e","cos_e","cos_e","cos_e","cos_e",
    "commonsense_qa","commonsense_qa","commonsense_qa","commonsense_qa","commonsense_qa",
    "dream","dream","dream","dream","dream",
    "quail","quail","quail","quail","quail","quail","quail","quail","quail","quail","quail","quail","quail",
    "quartz","quartz","quartz","quartz","quartz","quartz","quartz","quartz",
    "social_i_qa","social_i_qa","social_i_qa","social_i_qa","social_i_qa","social_i_qa",
    "wiqa","wiqa","wiqa","wiqa","wiqa","wiqa","wiqa","wiqa",
    "cosmos_qa","cosmos_qa","cosmos_qa","cosmos_qa","cosmos_qa","cosmos_qa","cosmos_qa","cosmos_qa","cosmos_qa","cosmos_qa","cosmos_qa","cosmos_qa","cosmos_qa",
    "qasc","qasc","qasc","qasc","qasc","qasc","qasc","qasc",
    "quarel","quarel","quarel","quarel","quarel",
    "sciq","sciq","sciq","sciq","sciq",
    "wiki_hop","wiki_hop","wiki_hop","wiki_hop","wiki_hop","wiki_hop","wiki_hop","wiki_hop","wiki_hop",
    "amazon_polarity","amazon_polarity","amazon_polarity","amazon_polarity","amazon_polarity","amazon_polarity","amazon_polarity","amazon_polarity","amazon_polarity",
    "app_reviews","app_reviews","app_reviews","app_reviews",
    "imdb","imdb","imdb","imdb","imdb","imdb","imdb","imdb","imdb","imdb","imdb",
    "rotten_tomatoes","rotten_tomatoes","rotten_tomatoes","rotten_tomatoes","rotten_tomatoes","rotten_tomatoes","rotten_tomatoes","rotten_tomatoes","rotten_tomatoes","rotten_tomatoes",
    "yelp_review_full","yelp_review_full","yelp_review_full","yelp_review_full","yelp_review_full","yelp_review_full","yelp_review_full",
    "paws","paws","paws","paws","paws","paws","paws","paws","paws","paws","paws","paws",
    "glue_qqp","glue_qqp","glue_qqp","glue_qqp","glue_qqp","glue_qqp",
    "glue_mrpc","glue_mrpc","glue_mrpc","glue_mrpc","glue_mrpc","glue_mrpc","glue_mrpc",
    "ag_news","ag_news","ag_news","ag_news","ag_news","ag_news","ag_news",
    "dbpedia_14","dbpedia_14","dbpedia_14","dbpedia_14",
    "adversarial_qa","adversarial_qa","adversarial_qa","adversarial_qa","adversarial_qa",
    "quoref","quoref","quoref","quoref","quoref","quoref","quoref","quoref","quoref","quoref","quoref",
    "ropes","ropes","ropes","ropes","ropes","ropes","ropes","ropes","ropes","ropes","ropes","ropes",
    "duorc","duorc","duorc","duorc","duorc","duorc","duorc","duorc","duorc",
    "hotpot_qa","hotpot_qa","hotpot_qa","hotpot_qa","hotpot_qa","hotpot_qa",
    "wiki_qa","wiki_qa","wiki_qa","wiki_qa","wiki_qa","wiki_qa","wiki_qa","wiki_qa","wiki_qa","wiki_qa","wiki_qa",
    "common_gen","common_gen","common_gen","common_gen","common_gen","common_gen","common_gen","common_gen","common_gen",
    "wiki_bio",
    "cnn_dailymail","cnn_dailymail","cnn_dailymail","cnn_dailymail","cnn_dailymail","cnn_dailymail","cnn_dailymail","cnn_dailymail","cnn_dailymail",
    "gigaword","gigaword","gigaword","gigaword","gigaword","gigaword","gigaword","gigaword","gigaword",
    "multi_news","multi_news","multi_news","multi_news","multi_news","multi_news",
    "samsum","samsum","samsum","samsum","samsum","samsum","samsum",
    ]
    
    data_args.eval_dataset_config_name =  [
    "none","none","none","none","none","none","none","none","none","none",
    "none","none","none","none","none","none","none","none","none","none","none","none","none","none","none","none","none","none",
    "v1.11","v1.11","v1.11","v1.11","v1.11","v1.11","v1.11","v1.11","v1.11","v1.11","v1.11",
    ...
    "labeled_final","labeled_final","labeled_final","labeled_final","labeled_final","labeled_final","labeled_final","labeled_final","labeled_final","labeled_final","labeled_final","labeled_final",
    "qqp","qqp","qqp","qqp","qqp","qqp",
    "mrpc","mrpc","mrpc","mrpc","mrpc","mrpc","mrpc",
    "none","none","none","none","none","none","none",
    "none","none","none","none",
    "adversarialQA","adversarialQA","adversarialQA","adversarialQA","adversarialQA",
    "none","none","none","none","none","none","none","none","none","none","none",
    "none","none","none","none","none","none","none","none","none","none","none","none",
    "ParaphraseRC","ParaphraseRC","ParaphraseRC","ParaphraseRC","ParaphraseRC","ParaphraseRC","ParaphraseRC","ParaphraseRC","ParaphraseRC",
    "fullwiki","fullwiki","fullwiki","fullwiki","fullwiki","fullwiki",
    "none","none","none","none","none","none","none","none","none","none","none",
    "none","none","none","none","none","none","none","none","none",
    "none",
    ...
    data_args.txt_save_dir= "output_logs_seen_eval_ct0_replication"
    #temp
    ...
    def compute_metrics(eval_preds, task_name):
        ...
        with open(f"./{data_args.txt_save_dir}/{data_args.dataset_name[0].replace('/',' ').replace('-',' ')}/{data_args.dataset_name[0].replace('/',' ').replace('-',' ')}*all-{task_name.replace('/',' ').replace('-',' ')}.txt",'a') as f:
    ...
    if training_args.do_train:
        ...
        if model_args.save_adapter_weights:
            ...
            # Implement adapter saving code here
            layer_cnt = 0
            for name, param in trainer.model.named_parameters():
            ...
            # print(train_result)
            # with open(os.path.join(training_args.output_dir,'flos.txt'),'w') as f:
            #     f.write('FLOS : ')
            #     f.write(train_result.metrics['total_flos'])
            #     f.write('\n')
            exit()
