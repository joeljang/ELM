...
class AdapterTrainingArguments:
    ...
    add_adapter_in_feed_forward: Optional[bool] = field(
        default=True, metadata={"help": "If set, adds adapters in the feedforward."})
    add_adapter_in_self_attention: Optional[bool] = field(
        default=True, metadata={"help": "If set, adds adapters in the selfattention"})
    ...
    adapters_cur_training_task: Optional[str] = field(
        default=None, metadata={"help": "currently training data name."}
    )